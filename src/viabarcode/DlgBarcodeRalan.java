            ...
            if(Sequel.cariRegistrasi(NoRawat.getText())>0){
                ...
                if(sukses==true){
                    ...
                    if(ttlpendapatan>0){
                        ...
                        if(Sequel.menyimpantf("tampjurnal","'"+Tindakan_Ralan+"','Pendapatan Tindakan Rawat Jalan','0','"+ttlpendapatan+"'","kredit=kredit+'"+(ttlpendapatan)+"'","kd_rek='"+Tindakan_Ralan+"'")==false){
                            sukses=false;
                        }                             
                    }
                    if(ttljmdokter>0){
